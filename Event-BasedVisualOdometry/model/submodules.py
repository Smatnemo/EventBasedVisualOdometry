...
class ConvLSTM(nn.Module):
    ...
    def __init__(self, input_size, hidden_size, kernel_size):
        ...
        self.Gates = nn.Conv2d(self.input_size + self.hidden_size, 4 * hidden_size, kernel_size, padding=pad)
...
class ConvGRU(nn.Module):
    ...
    Adapted from: https://github.self.com/jacobkimmel/pytorch_convgru/blob/master/convgru.py
    """
    ...
    def __init__(self, input_size, hidden_size, kernel_size):
        ...
        self.reset_gate = nn.Conv2d(self.input_size + self.hidden_size, self.hidden_size, kernel_size, padding=padding)
        self.update_gate = nn.Conv2d(self.input_size + self.hidden_size, self.hidden_size, kernel_size, padding=padding)
        self.out_gate = nn.Conv2d(self.input_size + self.hidden_size, self.hidden_size, kernel_size, padding=padding)
