...
class Trainer(BaseTrainer):
    ...
    def to_device(self, item):
        ...
        image = item['images'].float().to(self.device)
    ...
    def forward_sequence(self, sequence, all_losses=False):
        ...
        for i, item in enumerate(sequence):
            events, image = self.to_device(item)
    ...
    def _train_epoch(self, epoch):
        ...
        for batch_idx, sequence in enumerate(self.data_loader):
            ...
            for k, v in losses.items():
                print('This is the items', losses.items())
                self.train_metrics.update(k, v.item())
                print('This is the mean = ', v)
    ...
    def preview(self, sequence, epoch, tag_prefix=''):
        ...
        event_previews, pred_flows, pred_images, images, voxels = [], [], [], [], []
        self.model.reset_states()
        for i, item in enumerate(sequence):
        ...
        video_tensor = make_flow_movie(event_previews, pred_images, images)
